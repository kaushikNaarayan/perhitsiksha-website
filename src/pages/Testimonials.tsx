        ...
        <div className="max-w-7xl mx-auto container-padding">
          <div className="text-center mb-12">
            ...
            <p className="body-large text-gray-600 max-w-3xl mx-auto">
              Discover how education transforms lives through our most inspiring testimonials
            </p>
          </div>
      ...
      <section className="bg-gray-50 py-8 border-b">
        <div className="max-w-7xl mx-auto container-padding">
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            <div>
              <h2 className="text-xl font-semibold text-gray-900 mb-2">All Testimonials</h2>
              <p className="text-gray-600">Browse stories from our entire community</p>
            </div>
          ...
          {filteredTestimonials.length === 0 ? (
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredTestimonials.map((testimonial) => (
                <Card key={testimonial.id} className="overflow-hidden group hover:shadow-lg transition-all duration-300 cursor-pointer" onClick={() => handleVideoPlay(testimonial)}>
                  {/* Video Thumbnail */}
                  <div className="relative aspect-video bg-gray-900">
                    <img
                      src={getYouTubeThumbnail(testimonial.youtubeId!)}
      ...
      <section className="bg-primary-500 text-white section-padding">
        <div className="max-w-4xl mx-auto container-padding text-center">
          ...
          <p className="text-xl mb-8 text-primary-100">
            Every testimonial represents a life transformed through education. Your contribution can create the next success story.
          </p>
