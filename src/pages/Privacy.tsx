        ...
        <div className="max-w-4xl mx-auto container-padding">
          <div className="space-y-8 body-base text-gray-700 leading-relaxed">
            ...
            <div>
              ...
              <p>
                At CLSI (formerly Perhit Siksha), we are committed to protecting your privacy and ensuring the security of your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or interact with our services.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2 mb-4">
                ...
                <li>Student application details (for scholarship applicants)</li>
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>Processing donations and managing contributor relationships</li>
                <li>Evaluating and processing scholarship applications</li>
                <li>Providing updates on student progress and organizational activities</li>
                <li>Improving our website and services</li>
                <li>Responding to inquiries and providing customer support</li>
                <li>Complying with legal obligations</li>
                <li>Sending periodic emails about our programs (with your consent)</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li><strong>Student-Contributor Connection:</strong> With appropriate consent, we facilitate communication between students and their sponsors while maintaining privacy boundaries</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="mt-4">
                To exercise these rights, please contact us at clsi.perhitsiksha@gmail.com.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                These third-party services have their own privacy policies. We encourage you to review their privacy practices as we are not responsible for their content or privacy policies.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                We reserve the right to update this Privacy Policy at any time. When we make changes, we will revise the "Last updated" date at the top of this policy. We encourage you to review this Privacy Policy periodically to stay informed about how we protect your information.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <p className="font-semibold text-gray-900 mb-2">CLSI (Formerly Perhit Siksha)</p>
            ...
            <div className="border-t border-gray-200 pt-6">
              <p className="text-sm text-gray-500">
                This privacy policy is effective as of the date stated above and applies to all information collected by CLSI through our website and services.
              </p>
            </div>
          </div>
        </div>
